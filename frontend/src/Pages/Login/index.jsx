...
const Login = () => {
  ...
  const handleLoginSubmit = async (values) => {
    ...
    if (user) {
      try {
        const res = await axios.post("https://petsservice.onrender.com/auth/login", {
  ...
  const handleForgotPasswordSubmit = async (values) => {
    try {
      const res = await axios.post("https://petsservice.onrender.com/auth/resetPassword", {
        email: values.email,
      });
  ...
  const handleResetPasswordSubmit = async (values) => {
    try {
      const res = await axios.post(
        "https://petsservice.onrender.com/auth/updatePassword",
        {
          email: values.email,
